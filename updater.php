<?php
// PHP Web Updater - Overwrites server files with full webserver permissions
...
$targetFile = __DIR__ . '/controllers/AuthController.php';
$written = file_put_contents($targetFile, $authControllerCode);
...
echo json_encode([
    'status' => $written !== false ? 'success' : 'failed',
