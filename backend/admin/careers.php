<?php
// ==========================================================================
// BRIO WORLD SCHOOL - Core PHP Admin Careers Management
// ==========================================================================
...
try {
    $careers = $db->query("SELECT * FROM careers ORDER BY id DESC")->fetchAll();
} catch (Exception $e) {
    // Handle error
}
?>
...
<head>
  ...
  <title>Manage Careers - BRIO Admin Panel</title>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .status-badge { padding: 0.25rem 0.65rem; border-radius: 20px; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; background: rgba(5,150,105,0.15); color: #10B981; }
  </style>
</head>
<body>
  <header>
  ...
  <div class="container">
    ...
    <div class="card">
      <?php if (empty($careers)): ?>
        <p style="color: #64748B;">No career applications submitted yet.</p>
      <?php else: ?>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            <?php foreach ($careers as $c): ?>
              <tr>
                ...
                <td><span class="status-badge"><?= htmlspecialchars($c['job_title'] ?? '') ?></span></td>
                <td><?= (int)($c['experience'] ?? 0) ?> Years</td>
